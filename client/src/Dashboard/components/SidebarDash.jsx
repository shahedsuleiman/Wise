          ...
          >
            ...
            >
              <nav class="flex-1 px-2 pb-4 ">
                <a
                  href="/"
                  class="text-indigo-950 hover:bg-indigo-950 hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md"
                >
                  <svg
                    class="mr-3 flex-shrink-0 h-6 w-6 text-indigo-950 hover:text-white"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
