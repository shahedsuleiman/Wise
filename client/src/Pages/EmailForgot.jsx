        ...
        <div class="w-full px-8 max-w-lg space-y-6 bg-white rounded-md py-16">
          ...
          <form onSubmit={handleEmailSubmit} class="space-y-6 w-ful">
            ...
            <div>
              <button
                type="submit"
                class="w-full px-4 py-2 font-medium text-center text-white bg-indigo-950 transition-colors duration-200 rounded-md  hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-1"
              >
                Send
              </button>
            </div>
