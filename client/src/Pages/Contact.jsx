...
function Contact() {
  ...
  return (
    ...
    >
      <div class="flex flex-col mt-16 bg-indigo-950 bg-opacity-60">
        <div class="container flex flex-col flex-1 px-6 py-12 mx-auto">
          <div class="flex-1 lg:flex lg:items-center lg:-mx-6">
            <div class="text-white lg:w-1/2 lg:mx-6">
              <h1 class="text-2xl font-extrabold capitalize lg:text-4xl">
                Get Help Hassle-Free: Contact Us Today!
              </h1>

              <p class="max-w-xl mt-6 text-2xl font-semibold">
              ...
              <button class="px-8 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-indigo-950 rounded-md hover:bg-indigo-950 focus:outline-none focus:ring focus:ring-indigo-950 focus:ring-opacity-50">
                get in touch
              </button>
            ...
            <div class="mt-8 lg:w-1/2 lg:mx-6">
              <div class="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl dark:bg-gray-900 lg:max-w-xl">
                ...
                <form onSubmit={handleSubmit} class="mt-6">
                  ...
                  <button
                    type="submit"
                    class="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-indigo-950 rounded-md hover:bg-indigo-900 focus:outline-none focus:ring focus:ring-indigo-950 focus:ring-opacity-50"
                  >
                    get in touch
                  </button>
                </form>
