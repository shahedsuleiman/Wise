...
const addratetocourse = async (req, res) => {
  ...
  try {
    ...
    res
      .status(200)
      .json({ success: true, message: "your rate added successfully" });
  } catch (error) {
    console.error(error);
...
const addcommenttocourse = async (req, res) => {
  ...
  try {
    ...
    res
      .status(200)
      .json({ success: true, message: "Your comment added successfully" });
  } catch (error) {
    console.error(error);
    res.status(500).json({ error: "Internal Server Error" });
  }
...
const getcoursecomments = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ success: false, error: "Error in getting comments" });
  }
};
